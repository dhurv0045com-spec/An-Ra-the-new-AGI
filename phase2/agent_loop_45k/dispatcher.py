...
_TOOL_KEYWORDS = {
    ...
    "file_manager":  ["read file", "write file", "save", "load", "list files",
                      "create file", "delete file", "directory"],
    "os_action":     ["open file", "open folder", "launch", "reveal in explorer", "open url", "browser"],
    "cad_generate":  ["3d", "diagram", "cad", "openscad", "stl", "engine", "raptor", "model", "mesh", "cutaway"],
