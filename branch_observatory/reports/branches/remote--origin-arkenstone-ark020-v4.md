# refs/remotes/origin/arkenstone-ark020-v4

**Type:** `remote_tracking`  
**Tip:** `308a9865af519ccedd1fe13759e3b8ccdca85907`  
**Commit:** fix(arkenstone): add truthful cumulative progress reporter  
**Committer date:** 2026-09-13T12:59:08+05:30  
**Family:** research, evidence integration, and readiness / `arkenstone`  
**Captured:** `2026-09-24T21:08:59Z`

## Identity and custody

- Upstream: `none` (none); upstream divergence ahead/behind: N/A/N/A.
- Base: `b620f1c2d084b0db5fa0d24196949f88c92edc1e` by `configured_project_base`; ahead/behind 402/1.
- Worktrees: none; dirty state is an overlay, not committed tip content.
- Unique commits: 402; first/last UTC: 2026-08-16 / 2026-09-13; days since last: 11.

## Mission and soul

**Problem:** Discover mechanisms that improve transferable cognition per parameter/token/compute and promote only prospectively supported mechanisms.

**Thesis/design approach:** Retention, acquisition, invariance, and continual learning should be tested with state-dependent controls rather than inferred from a single success.

**Role in An-Ra:** Continual-cognition discovery and experiment portfolio.

**Unique contribution:** Large ledger of executed, replicated, and falsified bounded mechanisms plus a current unexecuted ARK-020/ARK-019 readiness path.

**Strongest evidence-backed result:** Multiple ARK experiments are recorded as executed and independently audited for narrow retention/invariance phenomena; the current ARK-020 build is explicitly NOT EXECUTED.

**Unresolved question:** Can the current multi-skill ARK-020 campaign prospectively demonstrate acquisition with retention and science preservation?

**Falsifier/failure condition:** A preregistered ARK-020 arm fails its acquisition, retention, interference, or efficiency gate under the frozen protocol.

**Read first:** `docs/arkenstone/CURRENT_STATE.md`, `docs/arkenstone/EXPERIMENT_LOG.md`, `docs/arkenstone/FAILURES.md`, `experiments/ARK-020-V4/RUN_READINESS_V4.json`
...
| Specified | SUPPORTED | high | refs/remotes/origin/arkenstone-ark020-v4:docs/arkenstone/CURRENT_STATE.md § Immediate Arkenstone execution priority @ 89c8426cd64b |
| Implemented | SUPPORTED | high | refs/remotes/origin/arkenstone-ark020-v4:docs/arkenstone/CURRENT_STATE.md § ARK-020 V4 @ 89c8426cd64b |
| Locally verified | SUPPORTED_BOUNDED | high | refs/remotes/origin/arkenstone-ark020-v4:docs/arkenstone/CURRENT_STATE.md § ARK-020 V4 @ 89c8426cd64b |
| CPU-tested | SUPPORTED_BOUNDED | high | refs/remotes/origin/arkenstone-ark020-v4:docs/arkenstone/CURRENT_STATE.md § ARK-020 V4 @ 89c8426cd64b |
| GPU-qualified | SUPPORTED_BOUNDED | high | refs/remotes/origin/arkenstone-ark020-v4:docs/arkenstone/EXPERIMENT_LOG.md § ARK-017 to ARK-018 @ 27b545a38902 |
| TPU-qualified | NOT_VERIFIED | high | refs/remotes/origin/arkenstone-ark020-v4:docs/arkenstone/CURRENT_STATE.md § Claim boundaries @ 89c8426cd64b |
| Executed scientifically | SUPPORTED_BOUNDED | high | refs/remotes/origin/arkenstone-ark020-v4:docs/arkenstone/EXPERIMENT_LOG.md § Experiments @ 27b545a38902 |
| Replicated | SUPPORTED_BOUNDED | high | refs/remotes/origin/arkenstone-ark020-v4:docs/arkenstone/CURRENT_STATE.md § Current causal model @ 89c8426cd64b |
| Supported within a bounded regime | SUPPORTED | high | refs/remotes/origin/arkenstone-ark020-v4:docs/arkenstone/CURRENT_STATE.md § Claim boundaries @ 89c8426cd64b |
| Negative result | RECORDED | high | refs/remotes/origin/arkenstone-ark020-v4:docs/arkenstone/FAILURES.md § 2026-09-06 to 2026-09-08 @ ceeaa3d8340f |
| Inconclusive | RECORDED | high | refs/remotes/origin/arkenstone-ark020-v4:docs/arkenstone/EXPERIMENT_LOG.md § ARK-013 and ARK-016 @ 27b545a38902 |
| Superseded | UNKNOWN | unknown | No reviewed evidence; UNKNOWN by policy. |
| Blocked | RECORDED | high | refs/remotes/origin/arkenstone-ark020-v4:docs/arkenstone/CURRENT_STATE.md § What not to do next @ 89c8426cd64b |
| Unknown | UNKNOWN | unknown | No reviewed evidence; UNKNOWN by policy. |

## Committed tip stock

- Production source lines: **48722**; tests: **9694**; docs: **15904**; notebook raw lines/cells: **2281 / 90**.
- Tracked blob files/bytes: **681 / 51388203**; binary files/bytes: **5 / 1388180**.
- Exact base-to-tip source stock change: **-46160** lines (-48.64990198351637%).
- Excluded samples: 0; large/uninspected samples: 16; source-category large files: 1.
- LOC comparison limited by uninspected large source files: **True**.
...
- Commit flow added/removed/net/churn: 64148 / 109784 / -45636 / 173932.
- Merge first-parent added/removed: 579 / 61.
- Recent windows: `{"1d": {"commit_count": 0, "docs_lines_added": 0, "docs_lines_removed": 0, "end_utc_day": "2026-09-24", "files_changed": 0, "generated_artifact_changes": 0, "notebook_changes": 0, "source_lines_added": 0, "source_lines_churn": 0, "source_lines_net": 0, "source_lines_removed": 0, "start_utc_day": "2026-09-24", "status": "known", "test_lines_added": 0, "test_lines_removed": 0}, "30d": {"commit_count": 351, "docs_lines_added": 476232, "docs_lines_removed": 131567, "end_utc_day": "2026-09-24", "files_changed": 1434, "generated_artifact_changes": 294, "notebook_changes": 41, "source_lines_added": 52511, "source_lines_churn": 64312, "source_lines_net": 40710, "source_lines_removed": 11801, "start_utc_day": "2026-08-26", "status": "known", "test_lines_added": 9825, "test_lines_removed": 3487}, "7d": {"commit_count": 0, "docs_lines_added": 0, "docs_lines_removed": 0, "end_utc_day": "2026-09-24", "files_changed": 0, "generated_artifact_changes": 0, "notebook_changes": 0, "source_lines_added": 0, "source_lines_churn": 0, "source_lines_net": 0, "source_lines_removed": 0, "start_utc_day": "2026-09-18", "status": "known", "test_lines_added": 0, "test_lines_removed": 0}, "90d": {"commit_count": 402, "docs_lines_added": 478497, "docs_lines_removed": 139000, "end_utc_day": "2026-09-24", "files_changed": 2317, "generated_artifact_changes": 333, "notebook_changes": 66, "source_lines_added": 64148, "source_lines_churn": 173932, "source_lines_net": -45636, "source_lines_removed": 109784, "start_utc_day": "2026-06-27", "status": "known", "test_lines_added": 13602, "test_lines_removed": 23009}}`.
...
This tip indexes 312 relevant documents. The complete record is in [specs_index.md](../specs_index.md).
...
| `docs/arkenstone/AGI_FEATURE_LEDGER.md` | evidence_ledger | unclear | N/A | One entry per proposed feature/mechanism with honest novelty, evidence, cost, and status. "AGI feature" is never claimed casually. |
| `docs/arkenstone/BRANCH_PROVENANCE.json` | machine_record | unclear | N/A | "schema": "arkenstone-branch-provenance/v1", "created_utc": "2026-09-05T17:27:54.127952Z", "arkenstone_branch": "Arkenstone", "arkenstone_base": "28bf57a0d299a2c13a99fe0046616c00a1b8530c", "worktree_path": "<local-path>", |
| … | … | … | … | 272 more in complete index |

## Authority and contradictions

- CURRENT_STATE.md is the operational handoff and explicitly corrects a believed but absent ARK-019 V4 result.
- Many historical findings are narrow and substrate-specific; they do not establish general AGI.
