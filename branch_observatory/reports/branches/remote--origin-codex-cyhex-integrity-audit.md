# refs/remotes/origin/codex/cyhex-integrity-audit

**Type:** `remote_tracking`  
**Tip:** `67220e2cbf012b4fa6f5a37990bb15e19cbc0d64`  
**Commit:** fix(horm): own bounded history and validate wrapper temperature; record audit scope  
**Committer date:** 2026-09-18T00:41:21+05:30  
**Family:** evidence integration and audit / `cymek-integrity`  
**Captured:** `2026-09-24T21:08:59Z`

## Identity and custody

- Upstream: `none` (none); upstream divergence ahead/behind: N/A/N/A.
- Base: `b620f1c2d084b0db5fa0d24196949f88c92edc1e` by `configured_project_base`; ahead/behind 509/1.
- Worktrees: none; dirty state is an overlay, not committed tip content.
- Unique commits: 509; first/last UTC: 2026-08-16 / 2026-09-17; days since last: 7.

## Mission and soul

**Problem:** Verify the custody and interpretability of historical CYR evidence without creating a new scientific outcome.

**Thesis/design approach:** A result bundle is authoritative only when source identity, receipt hashes, members, chronology, and corrections reconcile.

**Role in An-Ra:** Independent integrity/custody audit layered on the Cymek research family.

**Unique contribution:** Fail-closed bundle verification, discrepancy ledgers, and initial-tensor replay that preserve unknowns.

**Strongest evidence-backed result:** The audit verifies two SHA-checked bundles and records 23 focused tests plus initial-replay correspondence; it explicitly claims no causal ranking or new training.

**Unresolved question:** Why do the historical T4 and RTX 4050 runs differ after the documented source/identity comparison?

**Falsifier/failure condition:** A receipt, member, hash, chronology, or source identity fails fail-closed verification.

**Read first:** `docs/cymek/experiments/CYHEX_INTEGRITY_AUDIT.md`, `docs/cymek/experiments/CYR-GPU-012/CYR011_VS_CYR012_LEDGER.json`, `artifacts/cymek/evidence_ledger.json`
...
| Specified | SUPPORTED | high | refs/remotes/origin/codex/cyhex-integrity-audit:docs/cymek/experiments/CYHEX_INTEGRITY_AUDIT.md § Reproducibility ledger @ e0eff295e68c |
| Implemented | SUPPORTED | high | refs/remotes/origin/codex/cyhex-integrity-audit:docs/cymek/experiments/CYHEX_INTEGRITY_AUDIT.md § Verified @ e0eff295e68c |
| Locally verified | SUPPORTED | high | refs/remotes/origin/codex/cyhex-integrity-audit:docs/cymek/experiments/CYHEX_INTEGRITY_AUDIT.md § Validation @ e0eff295e68c |
| CPU-tested | SUPPORTED_BOUNDED | high | refs/remotes/origin/codex/cyhex-integrity-audit:docs/cymek/experiments/CYHEX_INTEGRITY_AUDIT.md § Validation @ e0eff295e68c |
| GPU-qualified | NOT_VERIFIED | high | refs/remotes/origin/codex/cyhex-integrity-audit:docs/cymek/experiments/CYHEX_INTEGRITY_AUDIT.md § Implemented but not fully verified / blocked / owner-required @ e0eff295e68c |
| TPU-qualified | NOT_VERIFIED | high | refs/remotes/origin/codex/cyhex-integrity-audit:docs/cymek/experiments/CYHEX_INTEGRITY_AUDIT.md § Consequence and next action @ e0eff295e68c |
| Executed scientifically | NOT_VERIFIED | high | refs/remotes/origin/codex/cyhex-integrity-audit:docs/cymek/experiments/CYHEX_INTEGRITY_AUDIT.md § Implemented but not fully verified / blocked / owner-required @ e0eff295e68c |
| Replicated | UNKNOWN | unknown | refs/remotes/origin/codex/cyhex-integrity-audit:docs/cymek/experiments/CYHEX_INTEGRITY_AUDIT.md § Reproducibility ledger @ e0eff295e68c |
| Supported within a bounded regime | SUPPORTED | high | refs/remotes/origin/codex/cyhex-integrity-audit:docs/cymek/experiments/CYHEX_INTEGRITY_AUDIT.md § Initial-tensor replay @ e0eff295e68c |
| Negative result | RECORDED | high | refs/remotes/origin/codex/cyhex-integrity-audit:docs/cymek/experiments/CYHEX_INTEGRITY_AUDIT.md § Implemented but not fully verified / blocked / owner-required @ e0eff295e68c |
| Inconclusive | RECORDED | high | refs/remotes/origin/codex/cyhex-integrity-audit:docs/cymek/experiments/CYHEX_INTEGRITY_AUDIT.md § Consequence and next action @ e0eff295e68c |
| Superseded | UNKNOWN | unknown | No reviewed evidence; UNKNOWN by policy. |
| Blocked | RECORDED | high | refs/remotes/origin/codex/cyhex-integrity-audit:docs/cymek/experiments/CYHEX_INTEGRITY_AUDIT.md § Implemented but not fully verified / blocked / owner-required @ e0eff295e68c |
| Unknown | UNKNOWN | unknown | No reviewed evidence; UNKNOWN by policy. |

## Committed tip stock

- Production source lines: **55364**; tests: **15172**; docs: **25743**; notebook raw lines/cells: **1950 / 78**.
- Tracked blob files/bytes: **757 / 84958311**; binary files/bytes: **5 / 1388180**.
- Exact base-to-tip source stock change: **-39518** lines (-41.649627958938474%).
...
- Commit flow added/removed/net/churn: 70790 / 109784 / -38994 / 180574.
- Merge first-parent added/removed: 579 / 61.
- Recent windows: `{"1d": {"commit_count": 0, "docs_lines_added": 0, "docs_lines_removed": 0, "end_utc_day": "2026-09-24", "files_changed": 0, "generated_artifact_changes": 0, "notebook_changes": 0, "source_lines_added": 0, "source_lines_churn": 0, "source_lines_net": 0, "source_lines_removed": 0, "start_utc_day": "2026-09-24", "status": "known", "test_lines_added": 0, "test_lines_removed": 0}, "30d": {"commit_count": 458, "docs_lines_added": 28933, "docs_lines_removed": 3944, "end_utc_day": "2026-09-24", "files_changed": 1489, "generated_artifact_changes": 219, "notebook_changes": 44, "source_lines_added": 59153, "source_lines_churn": 70954, "source_lines_net": 47352, "source_lines_removed": 11801, "start_utc_day": "2026-08-26", "status": "known", "test_lines_added": 15613, "test_lines_removed": 3797}, "7d": {"commit_count": 0, "docs_lines_added": 0, "docs_lines_removed": 0, "end_utc_day": "2026-09-24", "files_changed": 0, "generated_artifact_changes": 0, "notebook_changes": 0, "source_lines_added": 0, "source_lines_churn": 0, "source_lines_net": 0, "source_lines_removed": 0, "start_utc_day": "2026-09-18", "status": "known", "test_lines_added": 0, "test_lines_removed": 0}, "90d": {"commit_count": 509, "docs_lines_added": 31198, "docs_lines_removed": 11377, "end_utc_day": "2026-09-24", "files_changed": 2372, "generated_artifact_changes": 258, "notebook_changes": 69, "source_lines_added": 70790, "source_lines_churn": 180574, "source_lines_net": -38994, "source_lines_removed": 109784, "start_utc_day": "2026-06-27", "status": "known", "test_lines_added": 19390, "test_lines_removed": 23319}}`.
...
This tip indexes 298 relevant documents. The complete record is in [specs_index.md](../specs_index.md).
...
| `agent.md` | handoff_or_brief | superseded | 2026-09-17 | Branch: `codex/cyhex-integrity-audit` (audit baseline `d2abbdf`). Current interpretation corrections: `docs/cymek/experiments/REPLAY_SOURCE_AUDIT.md`. Historical initial-tensor identity and kernel selection both remain UNKNOWN. The CPU norm replay is not a historical replication. FORMATION-MUX remains `INCONCLUSIVE_AT_ZERO_BASELINE`; zero-baseline contrasts exonerate no mechanism. |
...
| … | … | … | … | 258 more in complete index |

## Authority and contradictions

- This branch audits evidence; it does not own the scientific result or authorize production.
- The audit explicitly labels missing checkpoint and cross-GPU explanations UNKNOWN.
