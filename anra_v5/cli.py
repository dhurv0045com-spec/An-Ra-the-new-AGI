...
SUBCOMMANDS: dict[str, tuple[str, str]] = {
    ...
    "data-qualify": ("v5_data.qualify", "validate a dataset manifest against acceptance gates"),
    "p35a-readiness": ("v5_experiments.p35a_readiness", "evaluate P35-A experiment readiness"),
    "data-status": ("v5_data.data_status", "report foundry inventory and data readiness"),    "e0-certify": ("e0_cognition.certify", "run E0 development certification"),
    ...
    "target-canary": ("v5_training.target_canary", "run the portable target-runtime canary"),
