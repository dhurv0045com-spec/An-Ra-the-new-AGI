...
Targeted recovery tests and focused CI coverage were added but not executed locally because the user prohibited local hardware use; no passing-test claim is made until Kaggle/CI runs them.
