...
- recovery-preflight v2 and its focused CI suite passed in GitHub Actions run `35925460488` at head `ee6a5cad4a4f39752b2646a60eeaeef8d2b06019`. The first run `35923273288` remains preserved negative engineering evidence after exposing a control-key defect fixed by commit `8609ba95f4e978cf3cdf8d20bd8a907eea8f6728`; the passing run qualifies recovery engineering only, not the absent saved Output.
