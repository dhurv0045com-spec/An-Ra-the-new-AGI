...
- E0 development infrastructure: **implemented and certified on development fixtures**
- E0 sealed promotion suite: **not yet frozen; external custody required**
- Current iteration: **evidence-building; no architecture retuning by prose**
...
The executable E0 research package lives in [`../../e0_cognition/`](../../e0_cognition/), with its deterministic receipt at [`../../artifacts/e0/development_certificate.json`](../../artifacts/e0/development_certificate.json). It is benchmark infrastructure, not production V5 code or model evidence. Post-Iteration-4 engineering specifications live in [`../../blueprints/`](../../blueprints/).
...
- **[FROZEN]** — fixed for Ground Blueprint v0.2; reopen only through `DECISIONS.md`.
...
- no production trainer, corpus pipeline, tokenizer, or model implementation;
...
Next action: finish context-position/output-format balancing, metric-specific confidence preregistration, and natural-source custody; then create the T2 seed and fixture under external custody and commit only its hash. E1 remains unauthorized until that exit gate passes.
