...
| M-008 | Column-selectivity precursor (frozen counterfactual probes) | NEW_PROGRAM_MEASUREMENT | absent from all branch receipts | factorization of the binding-heavy column should precede/emerge with OOD | TENTATIVE-SUPPORTED (LOO 4/4 vs baselines, n=4; ARK-004A) |
