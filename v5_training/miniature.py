"""End-to-end miniature proof of the entire production V5 path.

Runs REAL data through the REAL production machinery at reduced scale, on one
canonical code path:
...
Scale differs from V5-A (a miniature spec with the frozen 24,576-entry
tokenizer); the implementation path is identical.  The receipt classifies as
END_TO_END_MINIATURE and proves wiring and certification, never learning
quality.
"""
...
def run_miniature(
    *,
    ...
    store_root = repo / "artifacts/cymek/miniature_store"
