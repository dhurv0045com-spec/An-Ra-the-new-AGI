...
COGNITIVE_CAPABILITIES = (
    TechnologyContract(
        ...
        "cognition facade",
        "cognition.cre:CausalReasoningEngine.classify_query",
        ("A-01",),
    ),
    TechnologyContract(
        "C-02",
        "Epistemic Tracker",
        "cognition facade",
        "cognition.epistemic_tracker:EpistemicTracker.assess",
        ("A-02",),
    ),
    TechnologyContract(
        "C-03",
        "Longitudinal Human Model",
        "cognition facade",
        "cognition.lhm:LongitudinalHumanModel.inspect",
        ("A-03",),
    ),
    TechnologyContract(
        "C-04",
        ...
        "cognition facade",
        "cognition.ssie:ScientificSelfImprovementEngine.propose",
        ("A-04",),
    ),
    TechnologyContract(
        "C-05",
        ...
        "cognition facade",
        "cognition.cdse:CrossDomainSynthesisEngine.synthesize",
        ("A-05",),
    ),
    TechnologyContract(
        "C-06",
        ...
        "cognition facade",
        "cognition.cec:ContinuousExperienceConsolidator.consolidate",
        ("A-06",),
    ),
    TechnologyContract(
        "C-07",
        ...
        "cognition facade",
        "cognition.self_debate:MultiAgentSelfDebate.run",
        ("A-01", "A-02"),
    ),
)
