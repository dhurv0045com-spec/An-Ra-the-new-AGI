...
directly as a package from sys.path. This file sits inside phase3/45Q/
...
# ── Load phase3/45Q/__init__.py as a properly-named package ──────────────────
...
_PKG_DIR    = Path(__file__).parent                  # phase3/45Q/
