...
directly as a package from sys.path. This file sits inside phase3/symbolic_bridge_45q/
...
# ── Load phase3/symbolic_bridge_45q/__init__.py as a properly-named package ──────────────────
...
_PKG_DIR    = Path(__file__).parent                  # phase3/symbolic_bridge_45q/
