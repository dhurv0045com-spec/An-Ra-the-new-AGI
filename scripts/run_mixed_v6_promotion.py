...
def main() -> None:
    import connector.experiments.mixed_causal_v6 as mc
    ...
    FIX = mc.fixture_hash()
    pol = json.loads((ROOT / "output/self_model_v6.json").read_text(encoding="utf-8"))
    lam = pol["lambda"]
    ...
    policies["ADAPTIVE_v6"] = run_policy(lambda r: r["adaptive_action"])
    ...
    (ROOT / "output/mixed_causal_v6_replication.json").write_text(
