...
def main() -> None:
    import connector.experiments.mixed_causal_v5 as mc
    ...
    FIX = mc.fixture_hash()
    pol = json.loads((ROOT / "output/self_model_v5.json").read_text(encoding="utf-8"))
    lam = pol["lambda"]
    ...
    policies["ADAPTIVE_v5"] = run_policy(lambda r: r["adaptive_action"])
