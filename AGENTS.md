...
The active assignment combines the [complete learner program](engineering/master_program_20260913/README.md) with its [cognition and recursive-improvement extension](engineering/cognition_rsi_20260913/README.md): **M00–M24**. Read both packets completely. M00 now includes [chief F1–F6 on agent push acfa249](engineering/reports/B2_2_CHIEF_20260913/REVIEW.md); blanket B2.2 closure is not accepted. Continue independent contracts and provisional implementation under the dependency gates, while chief acceptance governs learned promotion. The live ledger is over its CPU cap at 206 updates; this continuation authorizes no optimizer updates or accelerator experiments. Older remaining-update instructions are exhausted. Use the [current agent prompt](engineering/cognition_rsi_20260913/AGENT_PROMPT.md).
