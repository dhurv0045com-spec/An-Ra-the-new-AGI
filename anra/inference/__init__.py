...
Generation logic lives in scripts/generate.py.
...
def generate_traced(*args, **kwargs):
    from scripts.generate import generate_traced as _generate_traced

    return _generate_traced(*args, **kwargs)


def generate_stream(*args, **kwargs):
    from scripts.generate import generate_stream as _generate_stream
