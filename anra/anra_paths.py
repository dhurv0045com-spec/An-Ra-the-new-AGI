...
class PathRegistry:
    ...
    DRIVE_HAL_STATE = DRIVE_HAL_STATE
    DRIVE_MEMORY = DRIVE_MEMORY
    DRIVE_SESSIONS = DRIVE_SESSIONS
    EPG_PATH = EPG_PATH
    FALSIFICATION_LEDGER_PATH = FALSIFICATION_LEDGER_PATH
    FAILURE_REPLAY_DATASET = FAILURE_REPLAY_DATASET
    HAL_STATE_FILE = HAL_STATE_FILE
    HAL_AUDIT_LOG = HAL_AUDIT_LOG
    AIE_ACTION_QUEUE = AIE_ACTION_QUEUE
    SELF_MOD_AUDIT_LOG = SELF_MOD_AUDIT_LOG
    DRIVE_DATA_DIR = DRIVE_DATA_DIR
    DRIVE_CODE_DIR = DRIVE_CODE_DIR
    DRIVE_TEACHER_DIR = DRIVE_TEACHER_DIR
    DRIVE_TEACHER_FILE = DRIVE_TEACHER_FILE
    ...
    SYMBOLIC_REASONING_V2_FILE = SYMBOLIC_REASONING_V2_FILE
    REASONING_JSONL_FILE = REASONING_JSONL_FILE
    DATASET = DATASET
    ...
    PRIVATE_EVAL_DIR = PRIVATE_EVAL_DIR
    TRAJECTORY_STORE = TRAJECTORY_STORE
    CDR_REPORT = CDR_REPORT
    METRIC_SNAPSHOT = METRIC_SNAPSHOT
    METRIC_HISTORY = METRIC_HISTORY
    IBS_LATEST = IBS_LATEST
    CIV_LATEST = CIV_LATEST
    MEMORY_PROFILE_3B = MEMORY_PROFILE_3B
    MODEL_GROWTH_REPORT = MODEL_GROWTH_REPORT
    TOKEN_INVENTORY_MANIFEST = TOKEN_INVENTORY_MANIFEST
    ...
    PROMOTED_RELEASE_MANIFEST = PROMOTED_RELEASE_MANIFEST
    SSG_AUDIT_LOG = SSG_AUDIT_LOG
    ...
    OPERATOR_AUDIT_LOG = OPERATOR_AUDIT_LOG
    DOCS_DIR = DOCS_DIR
