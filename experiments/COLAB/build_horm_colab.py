...
cells.append({"cell_type": "code", "metadata": {}, "source": [
    ...
    "# refuse to run with visible CUDA) execute exactly as designed. Torch\n",
    "# code in the runners still caps itself at 2 threads per preregistration;\n",
    "# the OMP/MKL=4 setting only speeds the surrounding full test suite.\n",
    "ENV = dict(os.environ, PYTHONPATH=\"/content/repo\",\n",
    "           CUDA_VISIBLE_DEVICES=\"\", OMP_NUM_THREADS=\"4\",\n",
    "           MKL_NUM_THREADS=\"4\", ANRA_TEST_DEVICE=\"cpu\")\n",
    "\n",
    "def run(*args):\n",
