...
cells.append({"cell_type": "code", "metadata": {}, "source": [
    ...
    "    \"-k\", \"not (%s or %s)\" % (PE_EXPR_B, PE_EXPR_A2),\n",
    "    *PE_DESELECT, threads=\"2\")\n",
    "run(*PE_BASE, \"%s/pea2.xml\" % LOGDIR,\n",
    "    \"-k\", PE_EXPR_A2, *PE_DESELECT, threads=\"2\")\n",
    ...
    "          (\"pea2\", \"production-entry state machine part 2\"),\n",
